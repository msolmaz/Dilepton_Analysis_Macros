...
class DileptonAnalysisCuts {
  public:
    ...
    static bool isComplementaryExtrapolated(const TreeDipseudoLeptonCandidate & cand, const Candidates * candidates, const std::vector<std::string> * triggers, 
  ...
  private:
    ...
    double minPt_MET_; // min di-lepton pt used for the MET trigger

...
std::map<TString, double> filesAndWeightsMap( bool electrons )
{
  ...
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/HTo2LongLivedTo4F_MH1000_MFF350_CTau35To3500_analysis_20140416"] = 0.5;
...
//  fw["/uscmst1b_scratch/lpc1/lpcmuon/zhenhu/Displaced_new4/CMSSW_5_3_8/src/workdirs/LongLivedTo2F_M_50_CTau350_analysis_20140122"] = 0.1;
  ...
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/ZZ_analysis_20140416"] = 17.6;
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/WZ_analysis_20140416"] = 33.2;
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/WW_analysis_20140416"] = 54.8;
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/WJetsToLNu_analysis_20140416"] = 36257.2;
  ...
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/TTJets_FullLept_analysis_20140416"] = 24.77;

  // DY JETS
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/DYJets10_analysis_20140416"] = 12471;
  fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/DYJets50_analysis_20140416"] = 3503.7;
  ...
  if (!electrons)
  {
    ...
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/QCDmu15_analysis_20140416"] = 2738580.0;
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/QCDmu20_analysis_20140416"] = 134680.0;


    // Data
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/Data_Mu_Run2012A22Jan_analysis_20140416"] = -1;
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/Data_Mu_Run2012B22Jan_analysis_20140416"] = -1;
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/Data_Mu_Run2012C22Jan_analysis_20140416"] = -1;
    fw["/eos/uscms/store/user/lpcdve/noreplica/DisplacedLeptons/Trees/Data_Mu_Run2012D22Jan_analysis_20140416"] = -1;
  }
  else
  {
  }

...
void DileptonAnalyzer::studyTrackingEfficiency(const std::vector <TreeLepton> single_cosmic_muons)
{
...
//Find the candidate that the lepton is associated with....
	   ...
	   if ( !correctLeptonsInCandidate(cand, leptonL, leptonH ) ) continue;
           ...
           DileptonAnalysisCuts::PassedWhichCuts finalCollCuts_studyTrack = dileptonCuts_finalColl_.whichCuts( single_cosmic_muons, cand, cand.mass, leptonL, leptonH, anaType_, lxyScale_, d0Scale_ );
                                          ...
                                          double & mass,Histograms & h, bool fillCorrectedTextFiles )
{
  ...
  DileptonAnalysisCuts::PassedWhichCuts finalCollCuts = dileptonCuts_finalColl_.whichCuts( single_cosmic_muons, cand, mass, leptonL, leptonH, anaType_, lxyScale_, d0Scale_ );
  DileptonAnalysisCuts::PassedWhichCuts looseCollCuts = dileptonCuts_looseColl_.whichCuts( single_cosmic_muons, cand, mass, leptonL, leptonH, anaType_, lxyScale_, d0Scale_ );
  DileptonAnalysisCuts::PassedWhichCuts controlCollCuts = dileptonCuts_controlColl_.whichCuts( single_cosmic_muons, cand, mass, leptonL, leptonH, anaType_, lxyScale_, d0Scale_ );
  DileptonAnalysisCuts::PassedWhichCuts looseControlCollCuts = dileptonCuts_looseControlColl_.whichCuts( single_cosmic_muons, cand, mass, leptonL, leptonH, anaType_, lxyScale_, d0Scale_ );
...
void DileptonAnalyzer::studyCandidate( std::vector <TreeLepton> single_cosmic_muons, TreeDipseudoLeptonCandidate &cand, TreeLepton& leptonL, TreeLepton& leptonH , Histograms & h, bool fillCorrectedTextFiles )
{
  ...
  //
  studyCollinearity( single_cosmic_muons, cand, leptonL, leptonH, mass, h, fillCorrectedTextFiles );
...
void DileptonAnalyzer::singleCosmicMuons( std::vector<TreeLepton> & single_cosmic_muon ) 
{
  // int numLeptons = 0;
  for ( unsigned int iTreeLepton=0; iTreeLepton != candidates->leptons_.size(); ++iTreeLepton ) {
    TreeLepton lepton = candidates->leptons_.at(iTreeLepton);

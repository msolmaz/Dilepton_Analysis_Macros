...
if (useCondor):
   ...
   if (sampleType.find("MC")>=0):
      ...
      isMC = False
   process.source.fileNames = cms.untracked.vstring("file:/uscmst1b_scratch/lpc1/lpcmuon/zhenhu/CMSDAS2013/CMSSW_5_3_6/src/CopyDataWithCRAB/AODCopy/crab_0_140623_144443/res/output_1_1_4qV.root")
...
process.MyHLTSelection = HLTrigger.HLTfilters.hltHighLevel_cfi.hltHighLevel.clone(
    HLTPaths = [ 'HLT_L2DoubleMu*_NoVertex*',
                 ...
                 "HLT_Photon36_R9Id85_OR_CaloId10_Iso50_Photon22_R9Id85_OR_CaloId10_Iso50_*",
                 "HLT_Photon36_R9Id85_Photon22_CaloId10_Iso50_*",
                 "HLT_Photon36_R9Id85_Photon22_R9Id85_*",
                 "HLT_Photon36_CaloId10_Iso50_Photon22_R9Id85_*",
                 "HLT_Photon36_CaloId10_Iso50_Photon22_CaloId10_Iso50_*"
                 # Higgs->4l triggers
...
#########
    if ( sampleDataSet.find("Run2012B-13Jul2012")>=0 or sampleDataSet.find("Run2012A-13Jul2012")>=0 ):
        ...
        pass
    if ( sampleDataSet.find("Run2012A")>=0 or sampleDataSet.find("Run2012B") or sampleDataSet.find("Run2012C")):
        process.p += process.hcallLaserEvent2012Filter
    pass
...
# Optionally apply pseudo lepton filter (usually applied except for signal MC)
if (plfilter) :
...
if (useCondor):
   process.out.fileName = cms.untracked.string("OUTPUTFILE.root")
else:

...
#             print "--------------------------------------------------------------------------------------------------------------------"
            ...
            for pdg in signalPdg:
                ...
                for lifeTimeFact in lifeTimeFactors:
                    ...
                    decayProducts = ''
                    if channel == '2muTrack' or channel == '2saMu' :
                        decayProducts='13'
                    ...
                    swNum=sumWeights( getEfficiencySumWeights( allExo, pdg, lifeTimeFact, originalCtau/10, decayProducts, 1, False, True, False, eventBasedEfficiencies ) )

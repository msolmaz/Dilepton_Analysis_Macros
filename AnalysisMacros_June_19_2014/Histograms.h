...
// Eta vs. Phi fr leptons
    ...
    TH1F * h_nMinus1_minHitsBeforeVertex_removedLifetimeNoVertex;
    TH1F * h_nMinus1_nMissingHitsAfterVertex_removedLifetimeNoVertex;
    TH1F * h_nMinus1_minMissingHitsAfterVertex_removedLifetimeNoVertex;
    TH1F * h_nMinus1_maxMissingHitsAfterVertex_removedLifetimeNoVertex;
    ...
    TH1F * h_ptOverE_removedLifetimeNoVertex;
    TH1F * h_ptMinusE_removedLifetimeNoVertex;
    TH1F * h_nCandsPerEvent_removedLifetimeNoVertex;
    TH1F * h_nMinus1_minValidStations_removedLifetimeNoVertex;
